    ...
    <div className="flex items-stretch justify-center gap-2.5">
      {cells.map((c, i) => (
        <div key={c.l} className="flex items-center gap-2.5">
          <div className="halftone-fine w-[68px] border-2 border-ink bg-cream px-2 py-2.5 text-center shadow-[3px_3px_0_var(--color-ink)] md:w-20">
          ...
          {i < cells.length - 1 && (
            <span className="font-display text-2xl text-clay" aria-hidden="true">
              :
            </span>
          )}
        </div>
